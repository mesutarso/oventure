                ...
                <div className="sticky top-0 flex w-full items-center overflow-hidden">
                    <motion.div style={{ x }} className="flex -ml-1">
                        ...
                        >
                            <div className="p-1">
                                <div
                                    className="rounded-xl border text-card-foreground bg-primary shadow-sm border-none w-full">
                        ...
                        >
                            <div className="p-1">
                                <div
                                    className="rounded-xl border text-card-foreground bg-secondary shadow-sm border-none w-full">
                                    <div className="flex aspect-[16/12] items-center justify-center p-0 relative">
                        ...
                        >
                            <div className="p-1">
                                <div
                                    className="rounded-xl border text-card-foreground bg-blueLight shadow-sm border-none w-full">
                                    <div className="flex aspect-[16/12] items-center justify-center p-0 relative">
                                        <h1 className="absolute bottom-0 left-0 p-10 text-3xl md:text-4xl lg:text-5xl font-black uppercase outlined-text text-white">
                                            analyses &amp; rapports
                                        </h1>
