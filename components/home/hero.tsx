  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-start justify-center h-full text-white space-y-8 container">
        <h1 className="text-2xl font-black leading-tight sm:text-3xl md:text-4xl lg:text-5xl lg:w-3/6 uppercase " data-aos="zoom-in" data-aos-duration="2500" >
          Catalyseur d&apos;innovation pour un monde
          <span className="text-secondary"> durable.</span>
        </h1>
        <p className="mt-4 text-xs sm:text-sm lg:text-base font-light lg:w-3/6" data-aos="zoom-in" data-aos-duration="2000">
